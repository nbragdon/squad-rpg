...
export const TimeshiftSkill: Skill = {
  ...
  effects: [TimeshiftDamageEffect, TimeshiftHasteBuff],
};
...
const GravityWellSlowDebuff: ApplyStatusEffectSkillEffect = {
  id: "gravity_well_slow_debuff",
  name: "Gravity Well Slow",
  type: SkillEffectType.applyStatusEffect,
  affinities: [AffinityType.radiance],
  targetType: TargetType.randomEnemy,
  statusEffectType: StatusEffectType.slow,
  value: 25, // 25% speed decrease
  stackable: true,
  duration: 3,
};
...
export const GravityWellSkill: Skill = {
  ...
  costStat: StatType.energy,
  effects: [
    GravityWellDamageEffect,
    GravityWellSlowDebuff,
    GravityWellStunEffect,
  ],
};
...
const CosmicShatterMagicDefDebuff: AdjustStatSkillEffect = {
  id: "cosmic_shatter_magic_def_debuff",
  name: "Cosmic Shatter Magic Defense Reduction",
  type: SkillEffectType.adjustStat,
  affinities: [AffinityType.radiance],
  targetType: TargetType.allEnemies,
  stat: StatType.magicDefense,
  direction: AdjustmentDirection.decrease,
  modifierValue: 20, // 20% magic defense reduction
  duration: 2,
};
...
export const CosmicShatterSkill: Skill = {
  ...
  costStat: StatType.energy,
  cooldownTurns: 5,
  effects: [CosmicShatterDamageEffect, CosmicShatterMagicDefDebuff],
};
...
const SoulDrainHealEffect: HealSkillEffect = {
  id: "soul_drain_heal_effect",
  name: "Soul Drain Heal",
  type: SkillEffectType.heal,
  affinities: [AffinityType.chaos, AffinityType.spirit],
  healMultiplier: 0.5,
  healStat: StatType.magic,
...
export const SoulDrainSkill: Skill = {
  ...
  cost: 30,
  costStat: StatType.energy,
  effects: [SoulDrainDamageEffect, SoulDrainHealEffect],
};
...
export const SoulRendSkill: Skill = {
  ...
  cost: 35,
  costStat: StatType.energy,
  effects: [SoulRendDamageEffect, SoulRendBleedEffect],
};
...
const WarpedRealityCritChanceDebuff: AdjustStatSkillEffect = {
  id: "warped_reality_crit_chance_debuff",
  name: "Warped Reality Crit Chance Reduction",
  type: SkillEffectType.adjustStat,
  affinities: [AffinityType.chaos],
  targetType: TargetType.allEnemies,
...
export const WarpedRealitySkill: Skill = {
  ...
  costStat: StatType.energy,
  cooldownTurns: 4,
  effects: [WarpedRealityConfusionEffect, WarpedRealityCritChanceDebuff],
};
...
const DimensionalRiftStunEffect: ApplyStatusEffectSkillEffect = {
  id: "dimensional_rift_stun_effect",
  name: "Dimensional Rift Stun",
  type: SkillEffectType.applyStatusEffect,
  affinities: [AffinityType.chaos],
  targetType: TargetType.randomEnemy,
  statusEffectType: StatusEffectType.stun,
...
export const DimensionalRiftSkill: Skill = {
  ...
  cost: 30,
  costStat: StatType.energy,
  effects: [DimensionalRiftDamageEffect, DimensionalRiftStunEffect],
};
