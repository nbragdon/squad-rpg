...
export const rareCharacters: CharacterBase[] = [
  {
    ...
    stats: {
      ...
      [StatType.magicDefense]: BASELINE.RARE[StatType.magicDefense] + 5,
      [StatType.speed]: BASELINE.RARE[StatType.speed] + 60,
      [StatType.critChance]: BASELINE.RARE[StatType.critChance],
      [StatType.critDamage]: BASELINE.RARE[StatType.critDamage],
    },
    skills: [TempestsFurySkill, TwinInsightSkill],
    ultimateSkill: TempestsFurySkill, // Placeholder
  ...
  },
  {
    ...
    skills: [TemporalShiftSkill, LostToTimeSkill],
  ...
  },
  {
    ...
    rarity: Rarity.RARE,
    stats: {
      [StatType.health]: BASELINE.RARE[StatType.health] + 120,
      [StatType.energy]: BASELINE.RARE[StatType.energy],
  ...
  },
  {
    ...
    stats: {
      ...
      [StatType.magic]: BASELINE.RARE[StatType.magic],
      [StatType.magicDefense]: BASELINE.RARE[StatType.magicDefense] + 15,
      [StatType.speed]: BASELINE.RARE[StatType.speed],
      [StatType.critChance]: BASELINE.RARE[StatType.critChance] + 15,
      [StatType.critDamage]: BASELINE.RARE[StatType.critDamage],
    },
